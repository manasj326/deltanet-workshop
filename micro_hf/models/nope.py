...
class GPTNoPEAttention(nn.Module):
    def __init__(self, config):
        ...
        if do_split_square:
            ...
            self.query_key_value = nn.Linear(config.hidden_size, 3 * config.hidden_size * self.num_attention_heads)
    ...
    def _merge_heads(cls, tensor, num_attention_heads, attn_head_size):
        ...
        if do_split_square:
            ...
            # tensor = tensor.view(tensor.size(0), tensor.size(1), attn_head_size)
